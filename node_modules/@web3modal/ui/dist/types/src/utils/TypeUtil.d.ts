...
export type TextType = 'large-500' | 'large-600' | 'large-700' | 'micro-600' | 'micro-700' | 'paragraph-500' | 'paragraph-600' | 'paragraph-700' | 'small-500' | 'small-600' | 'tiny-500' | 'tiny-600';
export type TextAlign = 'center' | 'left' | 'right';
export type SizeType = 'inherit' | 'lg' | 'md' | 'mdl' | 'sm' | 'xs' | 'xxs';
export type SpacingType = '0' | '1xs' | '3xl' | '3xs' | '4xs' | 'l' | '2l' | 'm' | 's' | 'xl' | 'xs' | 'xxl' | 'xxs';
